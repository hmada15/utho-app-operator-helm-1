...
```bash
helm install <release_name> utho-operator/utho-app-operator-chart --version 0.1.4 --set API_KEY=<YOUR_API_KEY> --set image.tag=0.1.4 -n <namespace> --create-namespace
```
